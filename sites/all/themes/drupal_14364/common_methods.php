...
function art_content_replace($content) {
  ...
  $article_str = ' class="free-templates-lt-article"';
...
function art_get_sidebar($sidebar, $vnavigation, $class) {
  $result = 'free-templates-lt-layout-cell ';
  if (empty($sidebar) && empty($vnavigation)) {
    $result .= 'free-templates-lt-content';
  }
  else {
    $result .= $class;
  }
...
function art_get_content_cell_style($left, $vnav_left, $right, $vnav_right, $content) {
  return 'free-templates-lt-layout-cell free-templates-lt-content'; 
}
...
function art_submitted_worker($date, $author) {
  ...
  if ($date != '') {
ob_start();?>
    <span class="free-templates-lt-postdateicon"><?php
    $output .= ob_get_clean();
    $output .= $date;
    ob_start();?>
    </span><?php
  ...
  if ($author != '') {
ob_start();?>
    <span class="free-templates-lt-postauthoricon"><?php if ($output != '') {
      $output .= '&nbsp;|&nbsp;';
    }
    $output .= ob_get_clean();
    $output .= $author;
...
function art_vmenu_output($subject, $content) {
  ...
  $output =	art_menu_worker($content, true, 'free-templates-lt-vmenu');
  $bvm = "<div class=\"free-templates-lt-box free-templates-lt-block\">\r\n    <div class=\"free-templates-lt-box-body free-templates-lt-block-body\">\r\n";
  $bvmt = "";
  $evmt = "";
  $bvmc = "<div class=\"free-templates-lt-box free-templates-lt-blockcontent\">\r\n    <div class=\"free-templates-lt-box-body free-templates-lt-blockcontent-body\">\r\n<div class=\"content\">\r\n";
  $evmc = "\r\n</div>\r\n		<div class=\"cleared\"></div>\r\n    </div>\r\n</div>\r\n";
  $evm = "\r\n		<div class=\"cleared\"></div>\r\n    </div>\r\n</div>\r\n";
  echo $bvm;
